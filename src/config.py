...
class BotConfig:
    ...
    rag_max_context_messages_low: int = 6
    rag_max_context_messages_medium: int = 10
    rag_max_context_messages_high: int = 14
    rag_embedding_min_words: int = 2
    rag_embedding_min_alphanumeric_chars: int = 12
    rag_vector_cache_enabled: bool = True
    rag_embedding_batch_delay_seconds: float = 1.0
    rag_embedding_drain_max_batches: int = 200
    rag_embedding_timeout_seconds: float = 30.0
    rag_embedding_retry_reset_hours: float = 24.0
    rag_bm25_weight_content: float = 1.0
    rag_bm25_weight_author: float = 0.1
    rag_bm25_weight_attachment: float = 0.5
    rag_fts_stopwords_enabled: bool = True
    rag_fts_min_and_results: int = 5
    rag_rrf_k: float = 60.0
    rag_fusion_weight_recent: float = 0.7
    rag_fusion_weight_lexical: float = 2.0
    rag_fusion_weight_semantic: float = 2.0
    rag_context_char_budget: int = 8000
    rag_query_embedding_cache_size: int = 128
    rag_query_embedding_cache_ttl: int = 900
    rag_conversation_enabled: bool = True
    rag_conversation_gap_minutes: float = 10.0
    rag_conversation_max_messages: int = 40
    rag_conversation_reply_merge_max_hours: float = 6.0
    rag_conversation_turnover_window: int = 3
    rag_conversation_turnover_min_gap_minutes: float = 3.0
    rag_conversation_expand_full_max_messages: int = 12
    rag_conversation_expand_window_messages: int = 8
    rag_query_rewrite_enabled: bool = True
    rag_query_rewrite_history_turns: int = 4
    rag_entity_profiles_enabled: bool = True
    rag_entity_profile_min_messages: int = 20
    rag_entity_profile_refresh_hours: float = 24.0
    rag_entity_profile_max_chars: int = 1200
